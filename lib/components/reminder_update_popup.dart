...
class _ReminderUpdatePopupState extends State<ReminderUpdatePopup> {
  ...
  bool validateFields() {
    ...
    if (titleController.text.isEmpty) {
      setState(() {
        errorMessage = 'Oops! Looks like your task lost its name.';
      });
      return false;
    }
    if (dateController.text.isEmpty) {
      setState(() {
        errorMessage = 'Date missing! Pick one!';
      });
      return false;
    }
    if (timeController.text.isEmpty) {
      setState(() {
        errorMessage = 'No time set? Pick a time!';
      });
      return false;
    }
    if (_selectedItem == null) {
      setState(() {
        errorMessage = 'Select a repeat frequency';
      });
      return false;
    }
    return true;
